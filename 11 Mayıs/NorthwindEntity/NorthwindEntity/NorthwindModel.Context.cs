...
namespace NorthwindEntity
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual DbSet<NakliyeKazanc> NakliyeKazanc { get; set; }
        public virtual DbSet<OlmayanUrunler> OlmayanUrunler { get; set; }
        ...
        public virtual DbSet<Silinmeyenler> Silinmeyenler { get; set; }
        ...
        public virtual ObjectResult<Nullable<decimal>> CalisanEkle(string calisanAdi, string calisanSoyadi)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("CalisanEkle", calisanAdiParameter, calisanSoyadiParameter);
        }
        ...
        public virtual int HareketGirisi(Nullable<int> cdNo, Nullable<int> hareketTanim)
        {
            var cdNoParameter = cdNo.HasValue ?
                new ObjectParameter("cdNo", cdNo) :
                new ObjectParameter("cdNo", typeof(int));
    
            var hareketTanimParameter = hareketTanim.HasValue ?
                new ObjectParameter("hareketTanim", hareketTanim) :
                new ObjectParameter("hareketTanim", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("HareketGirisi", cdNoParameter, hareketTanimParameter);
        }
        ...
        public virtual int UrunGuncelle(Nullable<int> urunId, string urunAdi, Nullable<decimal> birimFiyat, Nullable<int> stokMiktari)
        {
            ...
            var birimFiyatParameter = birimFiyat.HasValue ?
                new ObjectParameter("birimFiyat", birimFiyat) :
                new ObjectParameter("birimFiyat", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UrunGuncelle", urunIdParameter, urunAdiParameter, birimFiyatParameter, stokMiktariParameter);
        }
    
        public virtual ObjectResult<UrunVerStokIle_Result> UrunVerStokIle(Nullable<int> miktar)
        {
            var miktarParameter = miktar.HasValue ?
                new ObjectParameter("miktar", miktar) :
                new ObjectParameter("miktar", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UrunVerStokIle_Result>("UrunVerStokIle", miktarParameter);
        }
    }
}
